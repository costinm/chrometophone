...
public class LauncherUtils {
    ...
    public static void sendIntentToApp(Context context, Intent intent) {
        ...
        if (isScreenOffOrLocked(context) &&
            ...
            String queuedUrls =
                    prefs.getString(Prefs.QUEUED_URLS, "");
            String toAdd = intent.getDataString();
            queuedUrls = queuedUrls.length() == 0 ? toAdd : queuedUrls + "," + toAdd;
            editor.putString(Prefs.QUEUED_URLS, queuedUrls);
            editor.commit();
